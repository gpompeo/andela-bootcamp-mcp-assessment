"""MCP Client wrapper for HTTP JSON-RPC communication."""
...
class MCPClient:
    """Client for communicating with MCP server via HTTP JSON-RPC."""
    ...
    async def _post(self, payload: Dict[str, Any], expect_response: bool = True) -> Optional[Dict[str, Any]]:
    ...
    async def initialize(self) -> Dict[str, Any]:
        ...
        await self._post(initialized_payload, expect_response=False)
